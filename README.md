...
- ✅ **Ограничение времени жизни** - ссылки автоматически удаляются через 24 часа после создания
...
- **Показать User ID**: пункт меню `5` - показывает ваш текущий User ID
- **Установить User ID**: пункт меню `6` - позволяет установить существующий User ID для доступа к ранее созданным ссылкам
...
Система автоматически удаляет просроченные ссылки каждую минуту. Ссылки считаются просроченными, если прошло более 24 часов с момента создания.
...
- **Время жизни**: Настраивается пользователем при создании ссылки (по умолчанию 24 часа). Можно указать в часах или днях
